document.addEventListener('DOMContentLoaded', () => {
    ...
    function dragStartTouch(e) {
        ...
        if (figurenInSlots[index]) {
            ...
            // Erstelle ein visuelles Element zum Ziehen
            gezogenesElement = slot.querySelector('.figur-container').cloneNode(true);
            document.body.append(gezogenesElement);
            gezogenesElement.style.position = 'absolute';
            gezogenesElement.style.zIndex = '1000';
            gezogenesElement.style.pointerEvents = 'none'; // Wichtig, damit elementFromPoint funktioniert
            
            figurenSlots[index].innerHTML = ''; // Temporär aus Slot entfernen
            
            // Positioniere das gezogene Element initial an der Fingerposition
            dragMoveTouch(e);
        }
    }
    ...
    function dragMoveTouch(e) {
        ...
        // Positioniere das gezogene Element unter dem Finger
        ...
        // Finde heraus, was unter dem Finger ist
    ...
    function dropTouch(e) {
        ...
        if (gezogenesElement) gezogenesElement.remove();
        ...
        if (zelle) {
            if (kannPlatzieren(ausgewaehlteFigur, letztesZiel.x, letztesZiel.y)) {
