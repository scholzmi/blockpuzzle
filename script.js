document.addEventListener('DOMContentLoaded', () => {
    ...
    function eventListenerZuweisen() {
        ...
        // Universelle Listener für Klick und Touch auf den Slots
        ...
        // Klick/Maus-Listener für das Brett
        ...
        // Touch-Äquivalente für das Bewegen und Ablegen auf dem Brett
        spielbrettElement.addEventListener('touchmove', (e) => {
            e.preventDefault();
            if(ausgewaehlteFigur) {
                const touch = e.touches[0];
                const simuliertesMausEvent = new MouseEvent('mousemove', { clientX: touch.clientX, clientY: touch.clientY });
        ...
        spielbrettElement.addEventListener('touchend', (e) => {
            if(ausgewaehlteFigur){
                ...
                const simuliertesMausEvent = new MouseEvent('click', { clientX: touch.clientX, clientY: touch.clientY });
