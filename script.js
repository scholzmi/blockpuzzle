document.addEventListener('DOMContentLoaded', () => {
    ...
    // ... (alle Variablen bleiben gleich) ...
    
    // ===================================================================================
    // NEUE FUNKTION: Boss Key Logik
    // ===================================================================================
    function toggleBossKey() {
        document.body.classList.toggle('boss-key-aktiv');
        
        // Wenn der Boss-Key aktiviert wird UND eine Figur ausgewählt ist...
        if (document.body.classList.contains('boss-key-aktiv') && ausgewaehlteFigur) {
            // ... wird die Auswahl abgebrochen und die Figur zurückgelegt.
            abbrechen();
        }
    }
    // ===================================================================================
    ...
    // ... (alle anderen Funktionen wie ladeKonfiguration, spielStart etc. bleiben unverändert) ...
    ...
    function eventListenerZuweisen() {
        ...
        // Globale Listener für alle Geräte
        window.addEventListener('keydown', (e) => {
            if (e.key === 'Escape') {
                abbrechen();
            } else if (e.key.toLowerCase() === 'b') { //toLowerCase für Gross/Kleinschreibung
                toggleBossKey();
            }
        });
    ...
    // ... (alle weiteren Funktionen und der Spielstart bleiben unverändert) ...

    // HINWEIS: Da nur die eventListenerZuweisen-Funktion und die neue toggleBossKey-Funktion relevant sind,
    // ist hier nicht der gesamte Rest des Skripts abgebildet. Bitte füge die neuen Teile in deine
    // bestehende, funktionierende script.js ein.

    // Du kannst zur Sicherheit hier die komplette, finale Datei kopieren:
    ...
    function loescheVorschau() { document.querySelectorAll('.vorschau, .vorschau-ungueltig').forEach(zelle => { zelle.classList.remove('vorschau', 'vorschau-ungueltig'); if (!zelle.classList.contains('belegt')) { zelle.style.backgroundColor = ''; } }); }
