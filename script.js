document.addEventListener('DOMContentLoaded', () => {
    ...
    let gezogenesElement = null; // Für Touch
    ...
    async function spielStart() {
        ...
        if (!configGeladen) {
            spielbrettElement.innerHTML = '<p style="color: red; text-align: center;">Fehler beim Laden der Konfiguration!</p>';
            return;
        }
        
        // Stellt sicher, dass der Boss-Key-Modus beim Neustart deaktiviert wird
    ...
    /**
     * Wählt drei neue Figuren basierend auf den Wahrscheinlichkeiten aus.
     */
